...
/* Notes on spherical coordinates
   ...
   In spherical coordinates, we set zdom[0].NDIM = to whatever and zdom[0].MDIM = 1.  
...
Description:
	...
	In spherical coordinates w runs from 0 to zdom[0].NDIM.  Note that the 
     ...
     WindPtr w;
{
   ...
   * wind should be defined to include zdom[0].NDIM -1 */
